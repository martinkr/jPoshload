/** https://github.com/martinkr/jPoshLoad - Copyright (c) 2011-2014 Martin Krause - Dual licensed under the MIT and GPL licenses. */
(function(b){b.fn.jPoshLoad=function(g,e){jQuery("html").addClass("jPoshLoad_completed-false");var i=b.extend({},b.fn.jPoshLoad.oDefaults,e),f=jQuery(b.fn.jPoshLoad.createLoaderHTML(g,i)),j=jQuery(document).data("jPoshload")||{},l=e.images,h=e.forceNoCache||false,k;j[g]={oOptions:i,iTotal:0,_aLoad:[],_aLoaded:[],$elWrapper:f};for(k=0;k<l.length;k++){j[g]._aLoad.push(l[k])}j[g].iTotal=j[g]._aLoad.length;j[g].iLoaded=0;jQuery(document).data("jPoshload",j);for(k=0;k<l.length;k++){a(g,h,l[k])}};function a(e,f,h){var g=document.createElement("img");jQuery(g).on("load.jPoshLoad",{sIdLoader:e},b.fn.jPoshLoad.onLoadItem);g.src=[h,(f?["?",++b.fn.jPoshLoad.UID].join(""):"")].join("");if(g.complete||g.readyState===4){b.fn.jPoshLoad.onLoadItem({target:g,data:{sIdLoader:e}})}}function d(e){var f=jQuery(document).data("jPoshload")[e];return f.iTotal-f.iLoaded}function c(g){var h=jQuery(document).data("jPoshload")[g],f=h.$elWrapper,e=h.iTotal,i=h.iLoaded;b.fn.jPoshLoad.updateStatus({sIdLoader:g,iTotal:e,iLoaded:i,$elWrapper:f});if(i===e){b.fn.jPoshLoad.onComplete(g,f)}}b.fn.jPoshLoad.__version=2;b.fn.jPoshLoad.__class="$.fn.jPoshLoad";b.fn.jPoshLoad.UIDBase=new Date().getTime();b.fn.jPoshLoad.UID=b.fn.jPoshLoad.UIDBase;b.fn.jPoshLoad.sClassLoaded="jPoshLoad_loaded";b.fn.jPoshLoad.onLoadItem=function(g){var f=jQuery(g.target),h=jQuery(document).data("jPoshload"),e=g.data.sIdLoader;h[e].iLoaded=h[e].iLoaded+1;jQuery(document).data("jPoshload",h);f.off("load.jPoshLoad");f=null;c(e);return};b.fn.jPoshLoad.getStatus=function(e){return d(e)};b.fn.jPoshLoad.isComplete=function(e){return !d(e)};b.fn.jPoshLoad.oDefaults={forceNoCache:false,images:[]}})(jQuery);
/**
